:: 20190704 SFX_ETHZ_EC_Winx86_Build.cmd
::
...
:: 4. run SFX_ETHZ_EC_Winx86_Build.cmd (this file) either from CMD or by double clicking it
::
...
if exist ..\SFX_Output\ETHZ_EC_Winx86.exe del ..\SFX_Output\ETHZ_EC_Winx86.exe 
...
".\7za.exe" a -stl .\Installer.7z ..\ETHZ_EC_Winx86\*
...
:: The '7zsd_All.sfx.ORIGINAL' is the original file and the '7zsd_All.sfx.manifest' is for reference part of the folder too.
:: "c:\Program Files\Windows Kits\10\bin\10.0.18362.0\x86\mt.exe" -nologo -manifest ".\7zsd_All.sfx.manifest" -outputresource:".\7zsd_All.sfx;1"

:: 4rd ceate SFX
copy /B /Y .\7zsd_All.sfx + .\config.txt + .\Installer.7z ..\SFX_Output\ETHZ_EC_Winx86.exe
